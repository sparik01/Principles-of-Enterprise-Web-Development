	...
	try {
        ...
        try {
			...
			if(estimatedCost > 0 && validDuration.equals("valid") && validParty.contentEquals("valid")) {
				...
				//+ "<br/><a href=\"http://localhost:8080/Week12Assignment12\">Get Another Estimate</a>" + "</html> ";
    			  + "<br/><a href=\"https://web7.jhuep.com:443/Week12Assignment12\">Get Another Estimate</a>" + "</html> ";
							...
							//+ "</p></h1>" + "<a href=\"http://localhost:8080/Week12Assignment12\">Get Another Estimate</a>" + "</html> ";
			    			  + "</p></h1>" + "<a href=\"https://web7.jhuep.com:443/Week12Assignment12\">Get Another Estimate</a>" + "</html> ";

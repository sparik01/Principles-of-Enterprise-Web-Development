 ...
 *
 * @author evansrb1
 * from package com.rbevans.bookingrate provided in Week 5
 */
public class Rates {
...
//        BookingDay startDay = new BookingDay(2008,5,1);
//        BookingDay endDay = new BookingDay(2008,5, 7);
...
//        boolean success = rates.setDuration(0);
//        if (success == true)
